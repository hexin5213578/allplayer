...
enum T_AVColorPrimaries {
    kAVCOL_PRI_RESERVED0   = 0,
    kAVCOL_PRI_BT709       = 1, ///< also ITU-R BT1361 / IEC 61966-2-4 / SMPTE RP177 Annex B
    kAVCOL_PRI_UNSPECIFIED = 2,
    kAVCOL_PRI_RESERVED    = 3,
    kAVCOL_PRI_BT470M      = 4, ///< also FCC Title 47 Code of Federal Regulations 73.682 (a)(20)

    kAVCOL_PRI_BT470BG     = 5, ///< also ITU-R BT601-6 625 / ITU-R BT1358 625 / ITU-R BT1700 625 PAL & SECAM
    kAVCOL_PRI_SMPTE170M   = 6, ///< also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC
    kAVCOL_PRI_SMPTE240M   = 7, ///< functionally identical to above
    kAVCOL_PRI_FILM        = 8, ///< colour filters using Illuminant C
    kAVCOL_PRI_BT2020      = 9, ///< ITU-R BT2020
    kAVCOL_PRI_NB,              ///< Not part of ABI
};
...
enum T_AVColorTransferCharacteristic {
    kAVCOL_TRC_RESERVED0    = 0,
    kAVCOL_TRC_BT709        = 1,  ///< also ITU-R BT1361
    kAVCOL_TRC_UNSPECIFIED  = 2,
    kAVCOL_TRC_RESERVED     = 3,
    kAVCOL_TRC_GAMMA22      = 4,  ///< also ITU-R BT470M / ITU-R BT1700 625 PAL & SECAM
    kAVCOL_TRC_GAMMA28      = 5,  ///< also ITU-R BT470BG
    kAVCOL_TRC_SMPTE170M    = 6,  ///< also ITU-R BT601-6 525 or 625 / ITU-R BT1358 525 or 625 / ITU-R BT1700 NTSC
    kAVCOL_TRC_SMPTE240M    = 7,
    kAVCOL_TRC_LINEAR       = 8,  ///< "Linear transfer characteristics"
    kAVCOL_TRC_LOG          = 9,  ///< "Logarithmic transfer characteristic (100:1 range)"
    kAVCOL_TRC_LOG_SQRT     = 10, ///< "Logarithmic transfer characteristic (100 * Sqrt(10) : 1 range)"
    kAVCOL_TRC_IEC61966_2_4 = 11, ///< IEC 61966-2-4
    kAVCOL_TRC_BT1361_ECG   = 12, ///< ITU-R BT1361 Extended Colour Gamut
    kAVCOL_TRC_IEC61966_2_1 = 13, ///< IEC 61966-2-1 (sRGB or sYCC)
    kAVCOL_TRC_BT2020_10    = 14, ///< ITU-R BT2020 for 10 bit system
    kAVCOL_TRC_BT2020_12    = 15, ///< ITU-R BT2020 for 12 bit system
    kAVCOL_TRC_NB,                ///< Not part of ABI
};
 ...
 */
enum T_AVColorSpace {
    kAVCOL_SPC_RGB         = 0,  ///< order of coefficients is actually GBR, also IEC 61966-2-1 (sRGB)
    kAVCOL_SPC_BT709       = 1,  ///< also ITU-R BT1361 / IEC 61966-2-4 xvYCC709 / SMPTE RP177 Annex B
    kAVCOL_SPC_UNSPECIFIED = 2,
    kAVCOL_SPC_RESERVED    = 3,
    kAVCOL_SPC_FCC         = 4,  ///< FCC Title 47 Code of Federal Regulations 73.682 (a)(20)
    kAVCOL_SPC_BT470BG     = 5,  ///< also ITU-R BT601-6 625 / ITU-R BT1358 625 / ITU-R BT1700 625 PAL & SECAM / IEC 61966-2-4 xvYCC601
    kAVCOL_SPC_SMPTE170M   = 6,  ///< also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC / functionally identical to above
    kAVCOL_SPC_SMPTE240M   = 7,
    kAVCOL_SPC_YCOCG       = 8,  ///< Used by Dirac / VC-2 and H.264 FRext, see ITU-T SG16
    kAVCOL_SPC_BT2020_NCL  = 9,  ///< ITU-R BT2020 non-constant luminance system
    kAVCOL_SPC_BT2020_CL   = 10, ///< ITU-R BT2020 constant luminance system
    kAVCOL_SPC_NB,               ///< Not part of ABI
};

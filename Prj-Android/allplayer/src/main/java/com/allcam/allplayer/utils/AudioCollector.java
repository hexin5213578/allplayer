...
//		mAudioRecord = new AudioRecord(android.media.MediaRecorder.AudioSource.MIC, mSampleRate, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, mMinBufferSize); // mMinBufferSize这个参数必须大于等于一帧
		mAudioRecord = new AudioRecord(android.media.MediaRecorder.AudioSource.VOICE_COMMUNICATION, mSampleRate, AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, mMinBufferSize); // mMinBufferSize这个参数必须大于等于一帧

...
#include "OnNativePlayerState.h"
#include "OnNativePlayerBackData.h"
...
public:
    ...
    OnNativePlayerState *onNativePlayerState = NULL;
    OnNativePlayerBackData *onNativePlayerBackData = NULL;
...
public:
    ...
    ~JavaListenerContainer() {
        ...
        delete onNativePlayerState;
        onNativePlayerState = NULL;
        delete onNativePlayerBackData;
        onNativePlayerBackData = NULL;
    }

...
bool ac_shader::Init(XShaderType type)
{
    Close();
    //顶点和片元shader初始化
    //顶点shader初始化
    ...
    glBindAttribLocation(program, ATTRIB_TEXTURE, "aTexCoord");
...
void ac_shader::GetTexture(unsigned int index, int width, int height, const unsigned char *buf, bool isa)
{

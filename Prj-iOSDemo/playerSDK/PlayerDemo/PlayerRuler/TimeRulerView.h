...
//播放
-(void)playRecordWith:(NSString*)url cameraModel:(Payload*)mode;
...
@property (nonatomic, strong) RecordList* currentPlayRecord;
@property (nonatomic, assign) NSInteger currentPlayIndex;

@property (nonatomic, strong) Payload* currentCamera;
